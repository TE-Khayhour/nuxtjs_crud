...
const { mutate: createMutate } = useConvexMutation(api.incomes.create)
...
const handleSubmit = async () => {
  ...
  try {
    ...
    error.value = e.message || 'Failed to create income.'
  } finally {
    loading.value = false
  }
}
...
<template>
  <div>
    <div class="mb-6">
      ...
      <h1 class="text-2xl font-bold text-gray-900 mt-2">Add New Income</h1>
    </div>
