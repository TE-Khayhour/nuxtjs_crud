...
const { data: expense } = useConvexQuery(api.expenses.getById, () => ({
  id: expenseId as any,
}))

const { mutate: updateMutate } = useConvexMutation(api.expenses.update)
...
<template>
  <div>
    ...
    <div v-if="!expense && !loaded" class="text-gray-400 italic text-center py-12">
      Loading expense...
    </div>
